...
author: 'Chris F'
tags: ["deck-structure", "tdm", "illustrations"]
---
...
Some cards will seem to be one scene together (depending on your deck), for example the tower, the star, the moon and the sun all have water flowing or pooling and if you line them up it links them to each other.
...
You can also do this with the minor arcana or pips. And it is another source for your intuition when you read the cards.