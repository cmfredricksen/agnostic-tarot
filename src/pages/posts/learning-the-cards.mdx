...
author: 'Chris F'
tags: ["deck-structure", "getting-started", "tdm"]
image: {
    src: "../../images/cbd_tarot/c01.jpg",
    alt: "Ace of Cups",
    title: "Ace of Cups"
}
---
...
The major arcana contain scenes, characters and symbols. They are typically considered more significant in a reading. They allude to classic themes of life, love, work, death, money etc. They follow a story from I - XXI, a road traveled by the Fool. You can read these cards visually to start, use their titles as keywords, or use the basic keywords I have assigned to them on the [Keyword List](/posts/keywords).

Once you are fairly comfortable reading the cards you can do a deep dive on the major arcana and the court cards if you want. And remember that the more you read (_the cards_), the more you will find meanings that resonate with you, in all of the cards. 

## Pips

<div class="card-row">
<img src={aceCups.src} alt="Ace of Cups" title="Ace of Cups" />
<img src={sixSwords.src} alt="Six of Swords" title="Six of Swords"/>
<img src={twoBatons.src} alt="Two of Batons" title="Two of Batons"/>



</div>

The pips are the number cards, ace through ten. These are the cards of daily life and the cycles of life. Pip cards are different from scenic minor arcana found in most tarot decks. Pip cards do not have scenes with people in them. They are like playing cards, where:
- hearts = cups 
- clubs = batons 
- spades = swords 
- diamonds = coins 
...
<img src={pageCups.src} alt="Page of Cups"  title="Page of Cups"/>
<img src={kingBatons.src} alt="King of Batons"  title="King of Batons"/>
...
Next Step: [Learn the Suits](/posts/suits)

See also: [Keyword List](/posts/keywords)
