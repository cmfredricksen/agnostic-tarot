...
For this course you will need a Tarot de Marseille deck. Make sure you get an actual tarot deck.[^1] It should be a classic replica. Below are two recommendations you can order from the publishers' websites:
