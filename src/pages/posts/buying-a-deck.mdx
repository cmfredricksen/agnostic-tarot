...
<img src={fiveBatons.src} alt="Five of Batons" />
<img src={sixCoins.src} alt="Six of Coins" class="hidden" />
<img src={sevenCups.src} alt="Seven of Cups" class="hidden" />
...
&#9884;
<p>This deck comes other sizes and even an aged style</p>
