...
description: "Sometimes you should put your tarot deck back in order, it refreshes your readings!"
layout: "../../layouts/PostLayout.astro"
author: "Chris F"
tags: ["tdm", "practice", "deck-structure", "exercises"]
date: 2025-08-31
image: {
...
So what I do is reorder my deck. First I seperate them into 5 piles, turning each card upright as I go:
<ul class="rt-margin">
- Batons
- Cups
- Swords
...
Then I reorder each group, followed by putting all 5 groups in order (Majors, Batons, Cups, Swords, and Coins). Then it is done!
