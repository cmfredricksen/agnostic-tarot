...
<img src={oracles.src} alt="Oracle Cards" title="Oracle Cards" class="img-raw"/>
...
<img src={spread.src} alt="Celtic Cross spread with Oracle cards and Playing cards." title="Celtic Cross with oracle cards (left column) and playing cards (within the spread) showing a possible way of using them." class="img-raw" />
