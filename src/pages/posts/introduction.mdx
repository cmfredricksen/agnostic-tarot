...
<img src={theFool.src} alt="The Fool" />
<img src={twoCoins.src} alt="Two of Coins" class="hidden" />
<img src={twoSwords.src} alt="Two of Swords" class="hidden" />
...
<img src={knightSwords.src} alt="Knight of Swords" />
<img src={sixCups.src} alt="Six of Cups" class="hidden" />
<img src={sixBatons.src} alt="Six of Batons" class="hidden"/>
...
The keywords are like the first brush stroke on a blank canvas. They are a jumping off point to get moving. An easy way to break the inertia. A blank page will block your thinking. But once you start, even just one step, the blockage is removed.
...
Use my keywords or another simple set of keywords just to get experience handling the cards. Every reading will show you something new. I chose ranks/numbers because to start because it is a good base which can be used to build on. After numbers I would choose elements and then astrological associations - but those are more complex than numbers, in my opinion.
...
<a href="../posts/supplies">Tools of the Trade</a>

Basic structure of a tarot deck:

<a href="../posts/learning-the-cards.mdx">Learning the Cards</a>