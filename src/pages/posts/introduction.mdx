...
What I have done is assigned a keyword, one word to each rank. This is the starting point for the reading. The word is not negative or positive - just a neutral word. These words are based on numerology.

Once you have your keyword, there are different ways to build your reading. This guide will show you some of those ways.

The keywords used in agnostic tarot all have down to earth, practical meanings based in the mundane world. I have purposely avoided religious, spiritual, new age, or psychology associations. In this guide the focus is on getting practical experience with the cards. 
...
<img src={sixBatons.src} alt="Six of Batons" title="Six of Batons"/>

</div>

<p class="emphasis">Tarot is a tool available to anyone! You just need a deck!</p>
...
Use my keywords or another simple set of keywords just to get experience handling the cards. Every reading will show you something new. I chose ranks/numbers to start with because it is a good base to build on. Numbers are ever present.
...
[II. Tools of the Trade](/posts/supplies)
